...
namespace Hunted_Mobile.ViewModel {
    public class MapViewModel : BaseViewModel {
        ...
        public MapViewModel(Game gameModel, Model.Map mapModel, GpsService gpsService, LootRepository lootRepository, UserRepository userRepository, GameRepository gameRepository, BorderMarkerRepository borderMarkerRepository, ResourceRepository resourceRepository) {
